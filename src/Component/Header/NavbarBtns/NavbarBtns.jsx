    ...
    <>
      <div className={`h-100 w-navbar-item ${prop.display} justify-content-center align-items-center flex-row`}>
          <ul className='w-75 m-0 h-100 d-flex justify-content-between align-items-center flex-row-reverse'>
            ...
            <li className='list-group-item'><Link to='/' className='link-st'>صفحات قالب</Link></li>
            <li className='list-group-item'><Link to='/shop' className='link-st'>فروشگاه</Link></li>
            <li className='list-group-item'><Link to='/faqs' className='link-st'>سوالات متداول</Link></li>
            <li className='list-group-item'><Link to='/offers' className='link-st'>شگفت انگیزشو</Link></li>
            <li className='list-group-item'><Link to='/blogs' className='link-st'>وبلاگ</Link></li>
          </ul>
