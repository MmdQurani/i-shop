  ...
  return (
    <>
      <div className='Faqs-content'>
        ...
        {/* <div className='bg-danger py-3'>hello</div> */}
        <ArchiveContentTitle pageName='سوالات متداول' countItem='5 پرسش' />

        <Accordion defaultActiveKey="1" dir='rtl' className='d-flex flex-column row-gap-4 mt-4'>
